  ...
  class 水季类{
	...
	public void 设置( javax.servlet.http.HttpServletRequest 会话 ){
	  try{
		...
		set操作系统( String.valueOf( 属性.get( "os.name" ) ) + " " + String.valueOf( 属性.get( "os.version" ) ) );
		set操作系统类型( String.valueOf( 属性.get( "os.arch" ) ) );
		set操作系统模式( String.valueOf( 属性.get( "sun.arch.data.model" ) ) + "位" );
		...
		setJAVA运行环境名称( String.valueOf( 属性.get( "java.runtime.name" ) ) );
		setJAVA运行环境版本( String.valueOf( 属性.get( "java.runtime.version" ) ) );
		setJAVA运行环境说明书名称( String.valueOf( 属性.get( "java.specification.name" ) ) );
		setJAVA运行环境说明书版本( String.valueOf( 属性.get( "java.specification.version" ) ) );
		setJAVA虚拟机名称( String.valueOf( 属性.get( "java.vm.name" ) ) );
		setJAVA虚拟机版本( String.valueOf( 属性.get( "java.vm.version" ) ) );
		setJAVA虚拟机说明书名称( String.valueOf( 属性.get( "java.vm.specification.name" ) ) );
		setJAVA虚拟机说明书版本( String.valueOf( 属性.get( "java.vm.specification.version" ) ) );
		setJava_class_path( String.valueOf( 属性.get( "java.class.path" ) ).replaceAll( String.valueOf( 属性.get( "path.separator" ) ), String.valueOf( 属性.get( "path.separator" ) ) + "<br>" ) );
		setJava_home( String.valueOf( 属性.get( "java.home" ) ) );
		setJava_endorsed_dirs( String.valueOf( 属性.get( "java.endorsed.dirs" ) ) );
		setJava_library_path( String.valueOf( 属性.get( "java.library.path" ) ).replaceAll( String.valueOf( 属性.get( "path.separator" ) ), String.valueOf( 属性.get( "path.separator" ) ) + "<br>" ) );
		setJava_io_tmpdir( String.valueOf( 属性.get( "java.io.tmpdir" ) ) );
	  }catch( Exception 错误 ){
	    System.err.println( "水季探针出现错误->" + 错误.getMessage() );
	  }
    }
  }
...
<html>
  ...
  <table width="760" height="20" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
	  <td align="center">
	    选项：<a href="#ServerInfo">服务器相关参数</a> |
	    ...
	    <table border=0 width=100% cellspacing=1 cellpadding=3>
		  <tr>
			...
			<td width="30%" align="right">
			  ...
			  <span id=txt0 name=txt0><a href='#' onclick="showsubmenu(0)" title='关闭此项'><font color=#FFFFFF>↓</font></a></span>
			</td>
		  </tr>
		</table>
	  </td>
	  ...
	  <td>
	    <table border=0 width=100% cellspacing=1 cellpadding=0 class="InnerTable">
		  <tr>
            ...
            <td colspan="3" class="InnerMain"><%=水季.get主机名称()%>(<%=水季.get主机IP()%>)</td>
		  </tr>
		  <tr>
		    <td width="141" height="20" class="InnerHead">服务器操作系统</td>
            <td colspan="3" class="InnerMain"><%=水季.get操作系统()%></td>
		  </tr>
		  <tr>
		    <td height="20" class="InnerHead">服务器操作系统类型</td>
            <td class="InnerMain"><%=水季.get操作系统类型()%></td>
		    <td class="InnerHead">服务器操作系统模式</td>
		    <td class="InnerMain"><%=水季.get操作系统模式()%></td>
		  </tr>
		  <tr>
		    <td height="20" class="InnerHead">服务器所在地区</td>
            <td class="InnerMain"><%=水季.get服务器所在地区()%></td>
		    <td class="InnerHead">服务器语言</td>
		    <td class="InnerMain"><%=水季.get服务器语言()%></td>
		  </tr>
		  <tr>
		    <td height="20" class="InnerHead">服务器时区</td>
            <td class="InnerMain"><%=水季.get服务器时区()%></td>
		    <td class="InnerHead">服务器时间</td>
		    <td class="InnerMain"><%=水季.get服务器时间()%></td>
		  </tr>
		  <tr>
		    <td height="20" class="InnerHead">服务器解译引擎</td>
            <td class="InnerMain"><%=水季.get服务器解译引擎()%></td>
		    <td class="InnerHead">服务器端口</td>
		    <td class="InnerMain"><%=水季.get服务器端口()%></td>
		  </tr>
		  <tr>
		    <td height="20" class="InnerHead">当前用户</td>
            <td colspan="3" class="InnerMain"><%=水季.get当前用户()%></td>
	      </tr>
		  <tr>
		    <td height="20" class="InnerHead">用户目录</td>
            <td colspan="3" class="InnerMain"><%=水季.get用户目录()%></td>
	      </tr>
		  <tr>
		    <td height="20" class="InnerHead">本文件实际路径</td>
            <td colspan="3" class="InnerMain"><%=水季.get本文件实际路径()%></td>
	      </tr>
		</table>
	  </td>
	</tr>
	  ...
	  <td background="images/h.gif">
	    <table border=0 width=100% cellspacing=1 cellpadding=3>
		  <tr>
			...
			<td width="30%" align="right">
		      <a href="#top" title="返回顶部"><font color=#FFFFFF>TOP</font></a>
			  <span id=txt1 name=txt1><a href='#' onclick="showsubmenu(1)" title='关闭此项'><font color=#FFFFFF>↓</font></a></span>
			</td>
		  </tr>
		</table>
	  </td>
	  ...
	  <td>
	    <table border=0 width=100% cellspacing=1 cellpadding=0 class="InnerTable">
		  ...
		  <tr>
			...
			<td class="InnerMain"><%=水季.getJAVA运行环境名称()%></td>
			<td class="InnerMain"><%=水季.getJAVA运行环境版本()%></td>
		  </tr>
		  <tr>
		    <td height="20" class="InnerMain">JAVA运行环境说明书名称</td>
			<td class="InnerMain"><%=水季.getJAVA运行环境说明书名称()%></td>
			<td class="InnerMain"><%=水季.getJAVA运行环境说明书版本()%></td>
		  </tr>
		  <tr>
		    <td height="20" class="InnerMain">JAVA虚拟机名称</td>
			<td class="InnerMain"><%=水季.getJAVA虚拟机名称()%></td>
			<td class="InnerMain"><%=水季.getJAVA虚拟机版本()%></td>
		  </tr>
		  <tr>
		    <td height="20" class="InnerMain">JAVA虚拟机说明书名称</td>
			<td class="InnerMain"><%=水季.getJAVA虚拟机说明书名称()%></td>
			<td class="InnerMain"><%=水季.getJAVA虚拟机说明书版本()%></td>
		  </tr>
		  <tr>
		    <td height="20" class="InnerMain">JAVA虚拟机剩余内存</td>
			<td colspan="2" class="InnerMain"><img align=absmiddle class=PicBar width='<%=水季.getJAVA虚拟机剩余内存百分比()%>%'> <%=水季.getJAVA虚拟机剩余内存()%>M</td>
		  </tr>
		  <tr>
		    <td height="20" class="InnerMain">JAVA虚拟机分配内存</td>
			<td colspan="2" class="InnerMain"><img align=absmiddle class=PicBar width='85%'> <%=水季.getJAVA虚拟机分配内存()%>M</td>
		  </tr>
		  <tr>
		  ...
		  <tr>
			...
			<td colspan="2" class="InnerMain"><%=水季.getJava_class_path()%></td>
		  </tr>
		  <tr>
		    <td height="20" class="InnerMain">java.home</td>
			<td colspan="2" class="InnerMain"><%=水季.getJava_home()%></td>
		  </tr>
		  <tr>
		    <td height="20" class="InnerMain">java.endorsed.dirs</td>
			<td colspan="2" class="InnerMain"><%=水季.getJava_endorsed_dirs()%></td>
		  </tr>
		  <tr>
